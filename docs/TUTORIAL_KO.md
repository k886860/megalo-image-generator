...
![Project ID 확인](assets/gcp_01_project_id.png)

프로그램에 입력하는 값은 프로젝트 이름이 아니라 **Project ID**입니다.

![프로젝트 생성](assets/gcp_02_create_project.png)
...
![Cloud Shell](assets/gcp_03_cloud_shell_upload.png)

![배포 명령 실행](assets/gcp_04_deploy_commands.png)
...
![프로그램에 값 입력](assets/megalo_06_enter_values.png)
